...
import { DemoComponentProps, DemoComponent } from "./demo-component";
...
const factory: BlockFactory = (BaseBlockClass, widgetApi) => {
  /**
   *  <demo-component message="world!"></demo-component>
   */
  return class DemoComponentBlock extends BaseBlockClass implements BaseBlock {
    public constructor() {
      super();
    }

    private get props(): DemoComponentProps {
      const attrs = this.parseAttributes<DemoComponentProps>();
      return {
        ...attrs,
    ...
    public renderBlock(container: HTMLElement): void {
      ReactDOM.render(
        <DemoComponent {...this.props} widgetApi={widgetApi} />,
        container
      );
    }
